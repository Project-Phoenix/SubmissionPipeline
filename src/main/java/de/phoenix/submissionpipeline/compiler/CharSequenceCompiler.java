package de.phoenix.submissionpipeline.compiler;
...
public class CharSequenceCompiler<T> {
     ...
     * classes compiled by {@link #compile(String, CharSequence, Class...)}, for
     * example if the primary class contained nested classes or additional
     * non-public classes.
     * 
